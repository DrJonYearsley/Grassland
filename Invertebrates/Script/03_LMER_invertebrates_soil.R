...
# dir.create(paste0(data.dir,"LMER model invertebrates soil"))
# dir.create(paste0(figures.dir,"LMER model invertebrates soil"))
# dir.create(paste0(figures.dir,"LMER model invertebrates soil/Model validation"))
# dir.create(paste0(figures.dir,"LMER model invertebrates soil/Model output"))
# dir.create(paste0(figures.dir,"LMER model invertebrates soil/Residuals"))
# dir.create(paste0(figures.dir,"LMER model invertebrates soil/Soil moisture effect size boxplot"))
# dir.create(paste0(figures.dir,"LMER model invertebrates soil/Soil moisture effect size V1"))
# dir.create(paste0(figures.dir,"LMER model invertebrates soil/Soil moisture effect size V2"))

mydir.data <- paste0(data.dir,"LMER model invertebrates soil")
mydir <- paste0(figures.dir,"LMER model invertebrates soil")
...
for (daytime.hr in timepoint) {
  ...
  for (duration.hr in width) {
    ...
    plot.coll <- ggplot(result.coll, aes(x = Parameter, y = VIF)) +
      ...
      scale_fill_manual(values = mycol.coll) +
...
write.table(mod_summary, paste0(mydir.data, "/LMER Model summary - inverts BC vs soil moisture.csv"), 
            sep = ",", row.names = F)

write.table(aov_mod_final, paste0(mydir.data, "/LMER Anova output - inverts BC vs soil moisture.csv"), 
            sep = ",", row.names = F)

write.table(fixef_out_final, paste0(mydir.data, "/LMER Model output fixef - inverts BC vs soil moisture.csv"), 
            sep = ",", row.names = F)

write.table(random_out_final.1, paste0(mydir.data, "/LMER Model output random Region - inverts BC vs soil moisture.csv"), 
            sep = ",", row.names = F)

write.table(random_out_final.2, paste0(mydir.data, "/LMER Model output random Farm Region - inverts BC vs soil moisture.csv"), 
            sep = ",", row.names = F)
...
ggsave(paste0(mydir, "/LMER Model validation Inverts vs Soil Moisture - AIC vs Window width and mar R2.png"),
...
ggsave(paste0(mydir, "/LMER Model validation Inverts vs Soil Moisture - AIC vs Window width and con R2.png"),
...
ggsave(paste0(mydir, "/LMER Model validation Inverts vs Soil Moisture - AIC vs Window width R2.png"),
...
ggsave(paste0(mydir, "/LMER Model validation Inverts vs Soil Moisture - Marginal R2 vs AIC.png"),
...
ggsave(paste0(mydir, "/LMER Model validation Inverts vs Soil Moisture - Conditional R2 vs AIC.png"),
...
ggsave(paste0(mydir, "/LMER Model validation Inverts vs Soil Moisture - Shapiro test.png"),
...
ggsave(paste0(mydir, "/LMER Model validation Inverts vs Soil Moisture - Levene Test Region.png"),
...
ggsave(paste0(mydir, "/LMER Model validation Inverts vs Soil Moisture - Levene Test Region Farm.png"),
...
ggsave(paste0(mydir, "/LMER Model validation Inverts vs Soil Moisture - P values vs Window width.png"),
...
ggsave(paste0(mydir, "/LMER Model validation Inverts vs Soil Moisture - Significance of the terms.png"),
