...
# dir.create(paste0(data.dir,"LMER model trans invertebrates soil trt"))
# dir.create(paste0(figures.dir,"LMER model trans invertebrates soil trt"))
# dir.create(paste0(figures.dir,"LMER model trans invertebrates soil trt/Model validation"))
# dir.create(paste0(figures.dir,"LMER model trans invertebrates soil trt/Model output"))
# dir.create(paste0(figures.dir,"LMER model trans invertebrates soil trt/Residuals"))

mydir.data <- paste0(data.dir,"LMER model trans invertebrates soil trt")
mydir <- paste0(figures.dir,"LMER model trans invertebrates soil trt")
...
for (daytime.hr in timepoint) {
  ...
  for (duration.hr in width) {
    ...
    lmer_full_mod <- lmer(inverts_BC_all_cbrt ~ day*soil_ES*treatment + (1|Region/Farm),
                          data = df_joined)
    ...
    box.obs.trt <- ggplot(df_mod, aes(x = treatment, y = inverts_BC_all_cbrt, fill = treatment)) +
    ...
    check.resid.norm <- ggHistNorm(df_mod, df_mod$Residuals, "Residuals")
    ...
    final.plot0 <- grid.arrange(plot.norm,
                                ...
                                box.obs.region.farm,
                                ncol = 2,
                                top = tableGrob(t("lmer(inverts_BC_all_cbrt ~ day*soil_ES*treatment + (1|Region/Farm)"),
    ...
    final.plot3 <- grid.arrange(arrangeGrob(box.trt, box.region, box.farm, ncol = 3),
...
write.table(mod_summary, paste0(mydir.data, "/LMER Model summary - cbrt inverts BC vs soil moisture and trt.csv"), 
            sep = ",", row.names = F)

write.table(aov_mod_final, paste0(mydir.data, "/LMER Anova output - cbrt inverts BC vs soil moisture and trt.csv"), 
            sep = ",", row.names = F)

write.table(fixef_out_final, paste0(mydir.data, "/LMER Model output fixef - cbrt inverts BC vs soil moisture and trt.csv"), 
            sep = ",", row.names = F)

write.table(random_out_final.1, paste0(mydir.data, "/LMER Model output random Region - cbrt inverts BC vs soil moisture and trt.csv"), 
            sep = ",", row.names = F)

write.table(random_out_final.2, paste0(mydir.data, "/LMER Model output random Farm Region - cbrt inverts BC vs soil moisture and trt.csv"), 
            sep = ",", row.names = F)
...
ggsave(paste0(mydir, "/LMER Model validation cbrt Inverts vs Soil Moisture and Trt - AIC vs Window width and mar R2.png"),
...
ggsave(paste0(mydir, "/LMER Model validation cbrt Inverts vs Soil Moisture and Trt - AIC vs Window width and con R2.png"),
...
ggsave(paste0(mydir, "/LMER Model validation cbrt Inverts vs Soil Moisture and Trt - AIC vs Window width R2.png"),
...
ggsave(paste0(mydir, "/LMER Model validation cbrt Inverts vs Soil Moisture and Trt - Marginal R2 vs AIC.png"),
...
ggsave(paste0(mydir, "/LMER Model validation cbrt Inverts vs Soil Moisture and Trt - Conditional R2 vs AIC.png"),
...
ggsave(paste0(mydir, "/LMER Model validation cbrt Inverts vs Soil Moisture and Trt - Shapiro test.png"),
...
ggsave(paste0(mydir, "/LMER Model validation cbrt Inverts vs Soil Moisture and Trt - Levene Test Region.png"),
...
ggsave(paste0(mydir, "/LMER Model validation cbrt Inverts vs Soil Moisture and Trt - Levene Test Region Farm.png"),
...
ggsave(paste0(mydir, "/LMER Model validation cbrt Inverts vs Soil Moisture and Trt - P values vs Window width.png"),
...
ggsave(paste0(mydir, "/LMER Model validation cbrt Inverts vs Soil Moisture and Trt - Significance of the terms.png"),
