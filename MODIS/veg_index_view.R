# Import the processed MODIS data for pastures in Ireland (aggregated at the 1km or hectad scale)
...
# Only MODIS data with a 'useable' quality score should be used. 
#
...
#
# Note: if you look at the 1km spatial resolution data the plotting will take a while!
#
