...
### Edited 12.03.2019 to calculate variability of non-scaled anomalies and medians of resistances, recover times and recovery rates
### Edited 13.03.2019 to calculate longest recovery from biggest drops and slowest rate
...
write.csv(stability10km, 'J:\\Postdoc Grassland Resilience\\MODIS6\\Resilience\\stability10km.csv', row.names = FALSE)
