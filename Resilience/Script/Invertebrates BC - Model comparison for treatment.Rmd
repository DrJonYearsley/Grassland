---
title: "Invertebrates BC - Model comparison for treatment"
author: "Dr. Maja Ilić"
date: "3/23/2020"
...
```{r}
rand1 <- lmer(inverts_BC_all ~ day * treatment + (1|day) + (1|Farm) + (treatment|Region),
...
```{r}
rand1_nmkb <- lmer(inverts_BC_all ~ day * treatment + (1|day) + (1|Farm) + (treatment|Region),
                   data = resilience_inverts,
                   REML = T,
...
check_model(rand1_nmkb)
```

## SD and correlation of the random effects:  

```{r}
summary(rand1_nmkb)$varcor
```

## Variance of the random effects:  

```{r warning = F}
pander(summary(rand1_nmkb)$varcor, style = 'rmarkdown')
```

## Estimates for the random effects:  

```{r warning = F}
pander(ranef(rand1_nmkb), style = 'rmarkdown')
```

## Significance of the random effects:  

```{r message = F}
pander(rand(rand1_nmkb)[c(2,3,5,6)], style = 'rmarkdown')
```

## Significance of the fixed effects:  

```{r}
pander(anova(rand1_nmkb)[-3], style = 'rmarkdown')
```

## Visualize the model output using fitted values:  

```{r fig.width = 8, fig.height = 7}
out1 <- data.frame(resilience_inverts, "Fitted" = fitted(rand1_nmkb))  
...
ggplot(out1, 
  ...
  labs(x = "Days since the end of the simulated drought",
       title = "invertebrates_BC ~ day * treatment + (1|day) + (1|Farm) + (treatment|Region)",
...
```{r}
rand2 <- lmer(inverts_BC_all ~ day * treatment + (1|day) + (treatment|Region),
              data = resilience_inverts,
              REML = T) 
```
...
```{r}
rand2_nmkb <- lmer(inverts_BC_all ~ day * treatment + (1|day) + (treatment|Region),
                   data = resilience_inverts,
                   REML = T,
                   control = lmerControl(optimizer = "optimx", calc.derivs = FALSE,
                                         optCtrl = list(method = "nmkb", 
...
```{r fig.width = 8, fig.height = 7}
out2 <- data.frame(resilience_inverts, "Fitted" = fitted(rand2_nmkb))  
...
ggplot(out2, 
  ...
  scale_x_continuous(limits = c(0,64), breaks = c(0,8,16,32,64)) +
  labs(x = "Days since the end of the simulated drought",
       title = "invertebrates_BC ~ day * treatment + (1|day) + (treatment|Region)",
       subtitle = "lm(fitted data ~ day), optimizer: nmkb")
...
```{r}
rand3 <- lmer(inverts_BC_all ~ day * treatment + (1|Farm) + (treatment|Region),
              data = resilience_inverts,
              REML = T) 
```
...
ggplot(out3, 
  ...
  scale_x_continuous(limits = c(0,64), breaks = c(0,8,16,32,64)) +
  labs(x = "Days since the end of the simulated drought",
       title = "invertebrates_BC ~ day * treatment + (1|Farm) + (treatment|Region)",
...
```{r}
rand4 <- lmer(inverts_BC_all ~ day * treatment + (1|day) + (1|Region/Farm),
              data = resilience_inverts,
              REML = T) 
```
...
```{r}
rand4_bobyqa <- lmer(inverts_BC_all ~ day * treatment + (1|day) + (1|Region/Farm),
                     data = resilience_inverts,
                     REML = T,
...
check_model(rand4_bobyqa)
```

## SD and correlation of the random effects:  

```{r}
summary(rand4_bobyqa)$varcor
```

## Variance of the random effects:  

```{r warning = F}
pander(summary(rand4_bobyqa)$varcor, style = 'rmarkdown')
```

## Estimates for the random effects:  

```{r warning = F}
pander(ranef(rand4_bobyqa), style = 'rmarkdown')
```

## Significance of the random effects:  

```{r message = F}
pander(rand(rand4_bobyqa)[c(2,3,5,6)], style = 'rmarkdown')
```

## Significance of the fixed effects:  

```{r}
pander(anova(rand4_bobyqa)[-3], style = 'rmarkdown')
```

## Visualize the model output using fitted values:  

```{r fig.width = 8, fig.height = 7}
out4 <- data.frame(resilience_inverts, "Fitted" = fitted(rand4_bobyqa))  
...
ggplot(out4, 
  ...
  scale_x_continuous(limits = c(0,64), breaks = c(0,8,16,32,64)) +
  labs(x = "Days since the end of the simulated drought",
       title = "invertebrates_BC ~ day * treatment + (1|day) + (1|Region/Farm)",
...
```{r}
rand5 <- lmer(inverts_BC_all ~ day * treatment + (1|day),
              data = resilience_inverts,
              REML = T) 
```
...
ggplot(out5, 
  ...
  scale_x_continuous(limits = c(0,64), breaks = c(0,8,16,32,64)) +
  labs(x = "Days since the end of the simulated drought",
       title = "invertebrates_BC ~ day * treatment + (1|day)",
       subtitle = "lm(fitted data ~ day)")
...
```{r}
rand6 <- lmer(inverts_BC_all ~ day * treatment + (1|Region/Farm),
              data = resilience_inverts,
              REML = T) 
```
...
ggplot(out6, 
  ...
  scale_x_continuous(limits = c(0,64), breaks = c(0,8,16,32,64)) +
  labs(x = "Days since the end of the simulated drought",
       title = "invertebrates_BC ~ day * treatment + (1|Region/Farm)",
       subtitle = "lm(fitted data ~ day)")
...
```{r}
rand7 <- lmer(inverts_BC_all ~ day * treatment + (1|day) + (1|Region/Farm) + (treatment|Region),
              data = resilience_inverts,
              REML = T) 
```
...
```{r}
rand7_bobyqa <- lmer(inverts_BC_all ~ day * treatment + (1|day) + (1|Region/Farm) + (treatment|Region),
                     data = resilience_inverts,
                     REML = T,
                     control = lmerControl(optimizer = "bobyqa", 
                                           optCtrl = list(maxfun = 2e5)))
...
```{r}
rand7_nlminb <- lmer(inverts_BC_all ~ day * treatment + (1|day) + (1|Region/Farm) + (treatment|Region),
                     data = resilience_inverts,
                     REML = T,
                     control = lmerControl(optimizer = "optimx", calc.derivs = FALSE,
...
ggplot(out7, 
  ...
  scale_x_continuous(limits = c(0,64), breaks = c(0,8,16,32,64)) +
  labs(x = "Days since the end of the simulated drought",
       title = "invertebrates_BC ~ day * treatment + (1|day) + (1|Region/Farm) + (treatment|Region)",
...
```{r}
rand8 <- lmer(inverts_BC_all ~ day * treatment + (1|Region/Farm) + (treatment|Region),
              data = resilience_inverts,
              REML = T) 
```
...
```{r}
rand8_nlminb <- lmer(inverts_BC_all ~ day * treatment + (1|Region/Farm) + (treatment|Region),
                     data = resilience_inverts,
                     REML = T,
                     control = lmerControl(optimizer = "optimx", calc.derivs = FALSE,
                                           optCtrl = list(method = "nlminb", 
...
```{r}
summary(rand8)$varcor
```

## Variance of the random effects:  

```{r warning = F}
pander(summary(rand8)$varcor, style = 'rmarkdown')
```

## Estimates for the random effects:  

```{r warning = F}
pander(ranef(rand8), style = 'rmarkdown')
```

## Significance of the random effects:  

```{r message = F}
pander(rand(rand8)[c(2,3,5,6)], style = 'rmarkdown')
```

## Significance of the fixed effects:  

```{r}
pander(anova(rand8)[-3], style = 'rmarkdown')
```

## Visualize the model output using fitted values:  

```{r fig.width = 8, fig.height = 7}
out8 <- data.frame(resilience_inverts, "Fitted" = fitted(rand8))  
...
ggplot(out8, 
  ...
  scale_x_continuous(limits = c(0,64), breaks = c(0,8,16,32,64)) +
  labs(x = "Days since the end of the simulated drought",
       title = "invertebrates_BC ~ day * treatment + (1|Region/Farm) + (treatment|Region)",
       subtitle = "lm(fitted data ~ day)")
...
```{r}
rand9 <- lmer(inverts_BC_all ~ day * treatment + (1|day) + (1|Region/Farm) + (treatment - 1|Region),
              data = resilience_inverts,
              REML = T) 
```
...
```{r}
rand9_bobyqa <- lmer(inverts_BC_all ~ day * treatment + (1|day) + (1|Region/Farm) + (treatment - 1|Region),
                     data = resilience_inverts,
                     REML = T,
                     control = lmerControl(optimizer = "bobyqa", 
                                           optCtrl = list(maxfun = 2e5)))
...
```{r}
rand9_nlminb <- lmer(inverts_BC_all ~ day * treatment + (1|day) + (1|Region/Farm) + (treatment - 1|Region),
                     data = resilience_inverts,
                     REML = T,
                     control = lmerControl(optimizer = "optimx", calc.derivs = FALSE,
                                           optCtrl = list(method = "nlminb", 
...
```{r fig.width = 8, fig.height = 7}
out9 <- data.frame(resilience_inverts, "Fitted" = fitted(rand9_nlminb))  
...
ggplot(out9, 
  ...
  scale_x_continuous(limits = c(0,64), breaks = c(0,8,16,32,64)) +
  labs(x = "Days since the end of the simulated drought",
       title = "invertebrates_BC ~ day * treatment + (1|day) + (1|Region/Farm) + (treatment - 1|Region)",
       subtitle = "lm(fitted data ~ day), optimizer: nlminb")
...
```{r}
rand10 <- lmer(inverts_BC_all ~ day * treatment + (1|Region/Farm) + (treatment - 1|Region),
               data = resilience_inverts,
               REML = T) 
```
...
```{r}
rand10_nmkb <- lmer(inverts_BC_all ~ day * treatment + (1|Region/Farm) + (treatment - 1|Region),
                    data = resilience_inverts,
                    REML = T,
                    control = lmerControl(optimizer = "optimx", calc.derivs = FALSE,
                                          optCtrl = list(method = "nmkb", 
...
```{r fig.width = 8, fig.height = 7}
out10 <- data.frame(resilience_inverts, "Fitted" = fitted(rand10_nmkb))  
...
ggplot(out10, 
  ...
  scale_x_continuous(limits = c(0,64), breaks = c(0,8,16,32,64)) +
  labs(x = "Days since the end of the simulated drought",
       title = "invertebrates_BC ~ day * treatment + (1|Region/Farm) + (treatment - 1|Region)",
       subtitle = "lm(fitted data ~ day), optimizer: nmkb")
...
```{r}
result <- compare_performance(rand1_nmkb,rand2_nmkb,rand3, 
                              rand4_bobyqa,rand5,rand6,
                              rand7_nlminb,rand8,
