...
dir.create(paste0(figures.dir,"LMER model plant biomass day trt 2"))

mydir.data <- data.dir
mydir <- paste0(figures.dir,"LMER model plant biomass day trt 2")
...
write.table(aov_mod, paste0(mydir.data, "/LMER Anova output - Plant biomass ratio vs Day and Trt 2.csv"), 
            sep = ",", row.names = F)

write.table(fixef_out, paste0(mydir.data, "/LMER Model output fixef - Plant biomass ratio vs Day and Trt 2.csv"), 
            sep = ",", row.names = F)

write.table(random_out.1, paste0(mydir.data, "/LMER Model output random Farm Region - Plant biomass ratio vs Day and Trt 2.csv"), 
            sep = ",", row.names = F)

write.table(random_out.2, paste0(mydir.data, "/LMER Model output random Region - Plant biomass ratio vs Day and Trt 2.csv"), 
            sep = ",", row.names = F)
