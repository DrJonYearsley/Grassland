---
title: "Plant biomass ratio - Model comparison for acc rain"
author: "Dr. Maja Ilić"
date: "3/23/2020"
...
names(resilience_plant)[names(resilience_plant) == "rain_out"] <- "acc_rain"
```

## Rescaling day and acc_rain  

```{r}
resilience_plant_sc <- resilience_plant
resilience_plant_sc$day <- scale(resilience_plant_sc$day)
resilience_plant_sc$acc_rain <- scale(resilience_plant_sc$acc_rain)
```
...
```{r}
rand1_bobyqa <- lmer(plot_meanC_ratio ~ day * acc_rain + (1|day) + (1|Farm) + (acc_rain|Region),
                     data = resilience_plant_sc,
                     REML = T,
...
```{r}
rand1_nmkb <- lmer(plot_meanC_ratio ~ day * acc_rain + (1|day) + (1|Farm) + (acc_rain|Region),
                   data = resilience_plant_sc,
                   REML = T,
...
out1 <- data.frame(resilience_plant, "Fitted" = fitted(rand1_nmkb))  
...
ggplot(out1, 
  ...
  labs(x = "Days since the end of the simulated drought",
       title = "plant_biomass_ratio ~ day * acc_rain + (1|day) + (1|Farm) + (acc_rain|Region)",
...
```{r}
rand2_bobyqa <- lmer(plot_meanC_ratio ~ day * acc_rain + (1|day) + (acc_rain|Region),
                     data = resilience_plant_sc,
                     REML = T,
                     control = lmerControl(optimizer = "bobyqa", 
                                           optCtrl = list(maxfun = 2e5)))
...
```{r}
rand2_nmkb <- lmer(plot_meanC_ratio ~ day * acc_rain + (1|day) + (acc_rain|Region),
                   data = resilience_plant_sc,
                   REML = T,
                   control = lmerControl(optimizer = "optimx", calc.derivs = FALSE,
                                         optCtrl = list(method = "nmkb", 
...
ggplot(out2, 
  ...
  scale_x_continuous(limits = c(0,64), breaks = c(0,8,16,32,64)) +
  labs(x = "Days since the end of the simulated drought",
       title = "plant_biomass_ratio ~ day * acc_rain + (1|day) + (acc_rain|Region)",
       subtitle = "lm(fitted data ~ day), optimizer: nmkb")
...
```{r}
rand3_bobyqa <- lmer(plot_meanC_ratio ~ day * acc_rain + (1|Farm) + (acc_rain|Region),
                     data = resilience_plant_sc,
                     REML = T,
                     control = lmerControl(optimizer = "bobyqa", 
                                           optCtrl = list(maxfun = 2e5)))
...
```{r}
rand3_nmkb <- lmer(plot_meanC_ratio ~ day * acc_rain + (1|Farm) + (acc_rain|Region),
                   data = resilience_plant_sc,
                   REML = T,
                   control = lmerControl(optimizer = "optimx", calc.derivs = FALSE,
                                         optCtrl = list(method = "nmkb", 
...
ggplot(out3, 
  ...
  scale_x_continuous(limits = c(0,64), breaks = c(0,8,16,32,64)) +
  labs(x = "Days since the end of the simulated drought",
       title = "plant_biomass_ratio ~ day * acc_rain + (1|Farm) + (acc_rain|Region)",
       subtitle = "lm(fitted data ~ day), optimizer: nmkb")
...
```{r}
rand4_nmkb <- lmer(plot_meanC_ratio ~ day * acc_rain + (1|day) + (1|Region/Farm),
                   data = resilience_plant_sc,
                   REML = T,
                   control = lmerControl(optimizer = "optimx", calc.derivs = FALSE,
                                         optCtrl = list(method = "nmkb", 
...
ggplot(out4, 
  ...
  scale_x_continuous(limits = c(0,64), breaks = c(0,8,16,32,64)) +
  labs(x = "Days since the end of the simulated drought",
       title = "plant_biomass_ratio ~ day * acc_rain + (1|day) + (1|Region/Farm)",
       subtitle = "lm(fitted data ~ day), optimizer: nmkb")
...
ggplot(out5, 
  ...
  scale_x_continuous(limits = c(0,64), breaks = c(0,8,16,32,64)) +
  labs(x = "Days since the end of the simulated drought",
       title = "plant_biomass_ratio ~ day * acc_rain + (1|day)",
...
```{r}
rand6_nlminb <- lmer(plot_meanC_ratio ~ day * acc_rain + (1|Region/Farm),
                     data = resilience_plant_sc,
                     REML = T,
                     control = lmerControl(optimizer = "optimx", calc.derivs = FALSE,
                                           optCtrl = list(method = "nlminb", 
...
ggplot(out6, 
  ...
  scale_x_continuous(limits = c(0,64), breaks = c(0,8,16,32,64)) +
  labs(x = "Days since the end of the simulated drought",
       title = "plant_biomass_ratio ~ day * acc_rain + (1|Region/Farm)",
       subtitle = "lm(fitted data ~ day), optimizer: nlminb")
...
```{r}
rand7_bobyqa <- lmer(plot_meanC_ratio ~ day * acc_rain + (1|day) + (1|Region/Farm) + (acc_rain|Region),
                     data = resilience_plant_sc,
                     REML = T,
                     control = lmerControl(optimizer = "bobyqa", 
                                           optCtrl = list(maxfun = 2e5)))
...
ggplot(out7, 
  ...
  scale_x_continuous(limits = c(0,64), breaks = c(0,8,16,32,64)) +
  labs(x = "Days since the end of the simulated drought",
       title = "plant_biomass_ratio ~ day * acc_rain + (1|day) + (1|Region/Farm) + (acc_rain|Region)",
       subtitle = "lm(fitted data ~ day), optimizer: nlminb")
...
```{r}
rand8_bobyqa <- lmer(plot_meanC_ratio ~ day * acc_rain + (1|Region/Farm) + (acc_rain|Region),
                     data = resilience_plant_sc,
                     REML = T,
                     control = lmerControl(optimizer = "bobyqa", 
                                           optCtrl = list(maxfun = 2e5)))
...
ggplot(out8, 
  ...
  scale_x_continuous(limits = c(0,64), breaks = c(0,8,16,32,64)) +
  labs(x = "Days since the end of the simulated drought",
       title = "plant_biomass_ratio ~ day * acc_rain + (1|Region/Farm) + (acc_rain|Region)",
       subtitle = "lm(fitted data ~ day), optimizer: nlminb")
...
```{r}
rand9_bobyqa <- lmer(plot_meanC_ratio ~ day * acc_rain + (1|day) + (1|Region/Farm) + (acc_rain - 1|Region),
                     data = resilience_plant_sc,
                     REML = T,
                     control = lmerControl(optimizer = "bobyqa", 
                                           optCtrl = list(maxfun = 2e5)))
...
ggplot(out9, 
  ...
  scale_x_continuous(limits = c(0,64), breaks = c(0,8,16,32,64)) +
  labs(x = "Days since the end of the simulated drought",
       title = "plant_biomass_ratio ~ day * acc_rain + (1|day) + (1|Region/Farm) + (acc_rain - 1|Region)",
       subtitle = "lm(fitted data ~ day), optimizer: nlminb")
...
```{r}
rand10_bobyqa <- lmer(plot_meanC_ratio ~ day * acc_rain + (1|Region/Farm) + (acc_rain - 1|Region),
                      data = resilience_plant_sc,
                      REML = T,
                      control = lmerControl(optimizer = "bobyqa", 
                                            optCtrl = list(maxfun = 2e5)))
...
```{r}
rand10_nlminb <- lmer(plot_meanC_ratio ~ day * acc_rain + (1|Region/Farm) + (acc_rain - 1|Region),
                      data = resilience_plant_sc,
                      REML = T,
                      control = lmerControl(optimizer = "optimx", calc.derivs = FALSE,
                                            optCtrl = list(method = "nlminb", 
...
```{r fig.width = 8, fig.height = 7}
out10 <- data.frame(resilience_plant, "Fitted" = fitted(rand10_nlminb))  
...
ggplot(out10, 
  ...
  scale_x_continuous(limits = c(0,64), breaks = c(0,8,16,32,64)) +
  labs(x = "Days since the end of the simulated drought",
       title = "plant_biomass_ratio ~ day * acc_rain + (1|Region/Farm) + (acc_rain - 1|Region)",
       subtitle = "lm(fitted data ~ day), optimizer: nlminb")
...
```{r}
result <- compare_performance(rand1_nmkb,rand2_nmkb,rand3_nmkb,
